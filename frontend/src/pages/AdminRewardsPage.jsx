    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="glass-panel flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white/90 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs">
        ...
        <div className="flex items-center space-x-3">
          <button
            onClick={loadData}
            className="px-3.5 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-xl transition-colors cursor-pointer"
          >
            ↻ Refresh Data
          </button>
          <button
      ...
      {message && (
        ...
        >
          ...
          <button onClick={() => setMessage(null)} className="font-bold text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 cursor-pointer">✕</button>
        </div>
      )}

      {/* KPI Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card bg-white/90 dark:bg-slate-900/80 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-1">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400">From verified extra shift hours</p>
        </div>
        ...
        <div className="glass-card bg-white/90 dark:bg-slate-900/80 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-1">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Spent on catalog vouchers</p>
        </div>
        ...
        <div className="glass-card bg-white/90 dark:bg-slate-900/80 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-1">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Employees earning/redeeming points</p>
        </div>
        ...
        <div className="glass-card bg-white/90 dark:bg-slate-900/80 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-1">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Fulfillment order requests</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-card bg-white/90 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <div>
              <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">Weekly Points Trend (Last 7 Days)</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">Real points awarded daily based on verified checkout extra hours</p>
            </div>
          ...
          <div className="space-y-3 pt-2">
            {stats?.weekly_trend && stats.weekly_trend.length > 0 ? (
                ...
                return (
                  <div key={day.date} className="space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-semibold text-slate-700 dark:text-slate-300 w-28 truncate">
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 py-6 text-center">No trend data available.</p>
            )}
          </div>
        </div>

        {/* Top Earners Leaderboard */}
        <div className="glass-card bg-white/90 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs space-y-4">
          <div className="pb-3 border-b border-slate-100 dark:border-slate-800">
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">🏆 Top Point Earners</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">Highest all-time extra shift contributors</p>
          </div>

          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            {!stats?.top_earners || stats.top_earners.length === 0 ? (
              <p className="text-xs text-slate-400 dark:text-slate-500 py-6 text-center">No earners recorded yet.</p>
            ) : (
              stats.top_earners.map((emp, index) => (
                <div key={emp.id} className="py-2.5 flex items-center justify-between">
                  <div className="flex items-center space-x-2.5">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-slate-800 dark:text-slate-200">{emp.name}</h4>
                  ...
                  <div className="text-right">
                    <span className="text-xs font-bold font-mono text-amber-600 dark:text-amber-400 block">
                      {emp.balance} <span className="text-[10px] font-normal text-slate-500 dark:text-slate-400">pts</span>
                    </span>
      ...
      <div className="glass-card bg-white/90 dark:bg-slate-900/80 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-3 border-b border-slate-100 dark:border-slate-800 gap-3">
          <div>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">Rewards Catalog</h2>
        ...
        <div className="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-xl">
          <table className="w-full text-xs text-left">
            <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              <tr>
                  ...
                  <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    ...
                    <td className="py-3 px-4 text-right space-x-2">
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-md font-semibold cursor-pointer"
                      >
                        Edit
                      </button>
                      <button
      ...
      <div className="glass-card bg-white/90 dark:bg-slate-900/80 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-3 border-b border-slate-100 dark:border-slate-800 gap-3">
          <div>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">Employee Point Redemptions</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center space-x-2.5">
            <input
              ...
              className="px-3 py-1.5 border border-slate-300 dark:border-slate-700 rounded-lg text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200"
            />
            <select
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value)}
              className="px-3 py-1.5 border border-slate-300 dark:border-slate-700 rounded-lg text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 cursor-pointer"
            >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {filteredRedemptions.length === 0 ? (
                ...
                filteredRedemptions.map((red) => (
                  <tr key={red.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <td className="py-3 px-4 font-mono text-slate-500 dark:text-slate-400">#{red.id}</td>
                    <td className="py-3 px-4">
                      <span className="font-bold text-slate-800 dark:text-slate-200 block">{red.employee_name}</span>
                      <span className="text-[10px] text-slate-400 font-mono">{red.employee_code}</span>
                    </td>
                    <td className="py-3 px-4 font-semibold text-slate-700 dark:text-slate-300">{red.reward_name}</td>
                    <td className="py-3 px-4 font-mono font-bold text-amber-600 dark:text-amber-400">{red.points_spent} pts</td>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="glass-modal bg-white dark:bg-[#0f172a] rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <form onSubmit={handleSaveReward} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-slate-300 dark:border-slate-700 rounded-lg text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Points Cost</label>
                  <input
                    type="number"
                    min="0"
                    required
                    ...
                    className="w-full p-2 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-mono bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-slate-300 dark:border-slate-700 rounded-lg text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 cursor-pointer"
                >
              ...
              <div className="pt-3 flex justify-end space-x-2">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className="px-3.5 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-lg cursor-pointer"
                >
                  Cancel
                </button>
                <button
