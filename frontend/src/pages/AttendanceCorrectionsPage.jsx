              ...
              {loading ? (
                ...
                requests.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-4 px-5 whitespace-nowrap font-medium text-slate-800">{item.requested_date}</td>
                    ...
                    <td className="py-4 px-5 whitespace-nowrap">
                      <span className="px-2.5 py-0.5 rounded-md text-xs font-bold uppercase tracking-wider bg-slate-100 text-slate-700 border border-slate-200">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h3 className="text-lg font-bold text-slate-800">Request Attendance Correction</h3>
              <button
      ...
      {actionTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 space-y-4">
            ...
            <p className="text-xs text-slate-500">
              Correction by <strong>{actionTarget.request.employee_name}</strong> for date <strong>{actionTarget.request.requested_date}</strong> ({actionTarget.request.requested_status}).
            </p>
