...
export default function AdminManualAttendanceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="glass-modal bg-white dark:bg-[#0f172a] rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-slate-200 dark:border-slate-800">
        ...
        {/* Warning Banner */}
        <div className="bg-purple-50 dark:bg-purple-950/40 border-b border-purple-100 dark:border-purple-900/50 px-5 py-3 text-xs text-purple-900 dark:text-purple-200 flex items-start space-x-2">
          <span className="text-purple-600 dark:text-purple-400 font-bold text-sm shrink-0">ℹ️</span>
          <span>
            This administrative action manually overrides standard employee self-service QR & GPS geofencing. 
            The record will be marked with verification method <strong className="font-mono bg-purple-200/70 dark:bg-purple-900/60 dark:text-purple-200 px-1 py-0.5 rounded">ADMIN</strong> and logged in audit events.
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          {error && (
            <div className="p-3 bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-800 rounded-xl text-xs text-rose-700 dark:text-rose-300 flex items-center space-x-2 animate-in fade-in duration-150">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-xl text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:bg-slate-100 dark:disabled:bg-slate-900 cursor-pointer"
              required
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-xl text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:bg-slate-100 dark:disabled:bg-slate-900"
                required
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-xl text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
                required
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-xl text-xs font-mono bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-[11px] text-purple-600 dark:text-purple-400 font-semibold">Audit Mandatory</span>
            </div>
            <textarea
              name="reason"
              rows="3"
              ...
              className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-xl text-xs bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              required
            />
